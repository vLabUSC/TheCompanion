---
title: "Game Mode and Game State in Unreal Engine | Unreal Engine 5.7 Documentation"
source: "https://dev.epicgames.com/documentation/unreal-engine/game-mode-and-game-state-in-unreal-engine?application_version=5.7"
author:
published:
created: 2026-04-08
description: "Overview of the Game Mode and Game State in Unreal Engine"
tags:
  - "clippings"
---
...
- Default [Pawn](https://dev.epicgames.com/documentation/unreal-engine/pawn-in-unreal-engine) Class
- HUD Class
- [Player Controllers](https://dev.epicgames.com/documentation/unreal-engine/player-controllers-in-unreal-engine) Class
- Spectator Class
- Game State Class
- Player State Class
...
- URLs can be passed to the executable to force the game to load with specific options. Use the `game` option to set the game mode. See [Command-Line Arguments](https://dev.epicgames.com/documentation/unreal-engine/command-line-arguments-in-unreal-engine) for more information.
	```cpp
...
For an example of setting up a Game Mode, refer to the [Setting Up a Game Mode](https://dev.epicgames.com/documentation/unreal-engine/setting-up-a-game-mode-in-unreal-engine) documentation.
